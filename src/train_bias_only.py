...
def train(data_train_by_user, data_train_by_movie, data_test_by_user, data_test_by_movie, lamda, gamma, N):
    ...
    for tmp in range(N) :
        ...
        cout_train = cost_function(data_test_by_user, user_biases, movie_biases, lamda, gamma)
        cout_test  = cost_function(data_test_by_user, user_biases, movie_biases, lamda, gamma) 
        
        costs_train.append(cout_train)
        costs_test.append(cout_test)
    
    return user_biases, movie_biases, costs_train, costs_test
