...
@njit(parallel=True, fastmath=True)
def cost_function(indptr, indices, values, u_biases, m_biases, u, v, lamda, gamma, tau):
    m = len(u_biases)
...
def train(data_train_by_user, data_train_by_movie, data_test_by_user, 
    ...
    for iteration in range(N):
        ...
        r_train, loss_train = cost_function(indptr_user, indices_user, values_user,
                                      user_biases, movie_biases, u, v,
                                      lamda, gamma, tau)

        r_test, loss_test = cost_function(indptr_test_user, indices_test_user, values_test_user,
                                    user_biases, movie_biases, u, v,
                                    lamda, gamma, tau)
